...
export class CreateNewAllTables1709391367984 implements MigrationInterface {
    name = 'CreateNewAllTables1709391367984'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`images\` (\`id\` int NOT NULL AUTO_INCREMENT, \`fileName\` varchar(255) NOT NULL, \`url\` varchar(255) NOT NULL, \`peopleId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
